...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" className="border-sidebar-border/80">
      <SidebarHeader
        className={cn("px-4 py-3", SHELL_HEADER_HEIGHT, "flex items-center")}
      >
        <Link
          to="/hr/dashboard"
        ...
        >
          ...
          <div className={cn("min-w-0 flex-1", collapsed && "hidden")}>
            ...
            <p className="truncate text-xs leading-tight text-sidebar-foreground/65">
              Workspace
            </p>
          </div>
      ...
      <SidebarContent className="px-2 pt-2">
        <SidebarGroup className="px-2 py-2">
          <SidebarGroupLabel
            className={cn(
              "px-0 text-xs font-semibold normal-case tracking-normal text-sidebar-foreground/60",
              collapsed && "sr-only",
            )}
          >
            Workspace
      ...
      <SidebarFooter className="flex flex-col gap-2 p-4">
        <div className="flex justify-between items-center gap-2">
          ...
          <button
            ...
            className={cn(
              "flex h-8 w-fit items-center gap-2 rounded-md px-2 text-sm text-sidebar-foreground/75 transition hover:bg-sidebar-accent/70 hover:text-sidebar-accent-foreground",
